...
var getRandomNumber = function getRandomNumber(min, max, afterPoint) {
  if (afterPoint) {
    ...
    if (min >= 0 && max >= 0) {
      ...
      var _rand = min + Math.random() * (max - min);

      return Number(_rand.toFixed(afterPoint));
    }
...
/* harmony import */ var _module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module */ "./js/module.js");
